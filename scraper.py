...
def parse_link_list(list_url, create_subfolders=True):
    """
    ...
    try:
        ...
        for i, link in enumerate(links):
            ...
            file_path = download_gpx_zip(full_url)
            if file_path:
...
if __name__ == "__main__":
    ...
    if choice == "1":
        ...
        downloaded_files = parse_link_list(list_url, create_subfolders)
